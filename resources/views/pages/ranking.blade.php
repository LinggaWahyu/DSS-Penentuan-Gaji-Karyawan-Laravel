    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
          <h3>Ranking Matriks Penilaian Karyawan</h3>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Ranking Matriks Penilaian Karyawan Gaji Covid</h2>
            ...
            <div class="x_content">
              <form action="{{ route('ranking-kategori') }}" method="POST" class="form-inline">
                @csrf
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  @foreach ($nilais as $rank => $nilai)
                    <tr>
                      <td class="text-center">{{ $loop->iteration }}</td>
                      <td>{{ $nilai->karyawan->nama_karyawan }}</td>
