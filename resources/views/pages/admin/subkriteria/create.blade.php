    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form class="" action="{{ route('subkriteria.store') }}" method="post" novalidate>
              @csrf
                ...
                <div class="field item form-group">
                  ...
                  <input type="text" class="form-control col-md-6 col-sm-6" name="nama_sub_kriteria" placeholder="Subkriteria" aria-label="Username" aria-describedby="basic-addon1">
                </div>
                <div class="field item form-group">
                  <label class="col-form-label col-md-3 col-sm-3  label-align">Value<span class="required">*</span></label>
                  <input type="number" class="form-control col-md-6 col-sm-6" name="value" placeholder="Value" aria-label="Username" aria-describedby="basic-addon1">
                </div>
                <div class="ln_solid">
