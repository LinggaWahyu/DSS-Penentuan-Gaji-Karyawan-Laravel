  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h2>Tambah Kriteria Gaji Covid</h2>
          ...
          <div class="x_content">
            <form class="" action="{{ route('kriteria.store') }}" method="post" novalidate>
              @csrf
                ...
                <div class="field item form-group">
                    ...
                    <input type="text" name="nm_kriteria" class="form-control col-md-6 col-sm-6" placeholder="Kriteria" aria-label="Username" aria-describedby="basic-addon1">
                </div>
                <div class="field item form-group">
